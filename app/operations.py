...
class Modulus(Operation):
    ...
    def validate_operands(self, a: Decimal, b: Decimal) -> None:
        ...
        super().validate_operands(a, b)
        if b == 0:
            raise ValidationError("Cannot perform modulus with a divisor of zero")
...
class Percentage(Operation):
    ...
    def validate_operands(self, a: Decimal, b: Decimal) -> None:
        ...
        Overrides the base class method to validate the operands.

        Args:
            a (Decimal): The number.
            b (Decimal): The percentage.

        Raises:
            ValidationError: If the operands are invalid.
        """
        super().validate_operands(a, b)
    ...
    def execute(self, a: Decimal, b: Decimal) -> Decimal:
        ...
        Returns:
            Decimal: The calculated percentage of the number.
        """
        self.validate_operands(a, b)
...
class AbsoluteDifference(Operation):
    ...
    def execute(self, a: Decimal, b: Decimal) -> Decimal:
        ...
        Returns:
            Decimal: The absolute difference between the two numbers.
        """
        self.validate_operands(a, b)
        return abs(a - b)
